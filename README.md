...
| **Affiliates** | Approve/deactivate affiliates; set commission type (percent/fixed) and payout threshold; approve referrals to credit balance; mark payouts as paid |
...
| **Affiliate** | Apply to join; referral link with copy button; stats (balance, total earned, referral count); referral history; payout request |
...
- **Product addons** — optional extras attachable to services with their own billing cycle; admin and client self-service; auto-renewal invoices generated by cron
- **Affiliate program** — 30-day referral cookie; commission recorded on first order; percent or fixed commission types; admin-managed payout flow
