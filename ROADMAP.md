...
| **1.0.x patches** | OAuth, email delivery, sessions, SQL errors, cancellation enum, dashboard redesign, password change, license sync hardening, upgrade auth hardening | Released 2026-04-18 (latest: v1.0.18) |
