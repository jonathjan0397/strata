...
class InvoiceController extends Controller
{
    ...
    public function create(Request $request): Response
    {
        return Inertia::render('Admin/Invoices/Create', [
            ...
            'taxRates' => TaxRate::where('active', true)->orderBy('name')->get(['id', 'name', 'rate', 'country', 'state', 'is_default']),
        ]);
    }
    ...
    public function download(Invoice $invoice): HttpResponse|JsonResponse
    {
