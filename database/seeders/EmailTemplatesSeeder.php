    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'body_html' => '<p>Hi {{name}},</p><p>Your service <strong>{{service_name}}</strong> has been suspended.</p><p><strong>Reason:</strong> {{reason}}</p><p>If you believe this is an error or would like to resolve this, please contact our support team or log in to the client portal.</p><p><a href="{{portal_url}}" class="btn">View in Client Portal</a></p><p>Thanks,<br>The {{app_name}} Team</p>',
                'body_plain' => "Hi {{name}},\n\nYour service {{service_name}} has been suspended.\n\nReason: {{reason}}\n\nPlease log in to the client portal or contact support to resolve this.\n\n{{portal_url}}\n\nThanks,\nThe {{app_name}} Team",
            ],
            [
                'slug' => 'service.reactivated',
                'name' => 'Service Reactivated',
                'subject' => 'Service Reactivated — {{service_name}}',
                'body_html' => '<p>Hi {{name}},</p><p>Great news — your service <strong>{{service_name}}</strong> has been reactivated and is now active.</p><p><a href="{{portal_url}}" class="btn">View in Client Portal</a></p><p>If you have any questions, please don\'t hesitate to open a support ticket.</p><p>Thanks,<br>The {{app_name}} Team</p>',
                'body_plain' => "Hi {{name}},\n\nYour service {{service_name}} has been reactivated and is now active.\n\nView it here: {{portal_url}}\n\nThanks,\nThe {{app_name}} Team",
            ],
            [
                'slug' => 'service.terminated',
                'name' => 'Service Terminated',
                'subject' => 'Service Terminated — {{service_name}}',
                'body_html' => '<p>Hi {{name}},</p><p>Your service <strong>{{service_name}}</strong> has been terminated.</p><p><strong>Reason:</strong> {{reason}}</p><p>Any associated data on the server has been removed. If you believe this is an error, please contact support as soon as possible.</p><p>Thanks,<br>The {{app_name}} Team</p>',
